package sk.tuke.cucumber.stepdefs;
...
import sk.tuke.web.rest.AdminUserResource;
...
public class UserStepDefs extends StepDefs {
    ...
    public void setup() {
        ...
        this.userResourceMock = MockMvcBuilders.standaloneSetup(adminUserResource).build();
    }
