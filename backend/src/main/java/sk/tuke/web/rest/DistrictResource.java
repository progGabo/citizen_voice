...
import sk.tuke.domain.Authority;
import sk.tuke.repository.AuthorityRepository;
import sk.tuke.web.rest.errors.BadRequestAlertException;
...
public class DistrictResource {
    ...
    public DistrictResource(AuthorityRepository authorityRepository) {
